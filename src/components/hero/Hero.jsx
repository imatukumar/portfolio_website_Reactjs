...
function Hero() {
  return (
    <div className='relative overflow-hidden min-h-[550px] sm-min-h[650px] flex flex-col items-center'>
      ...
      <section id='home' className='flex flex-col md:flex-row items-center justify-center  px-4 md:px-52 md:pl-5 md:pr-0 pb-4 md:pd-24 md:pt-32 pt-24 md:pb-24 mt-24 md:mt-0 z-10'>
       <div className='flex-1 md:text-left mt-10 md:mt-0'>
           <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4'>Atul Kumar</h1>
